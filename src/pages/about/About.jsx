...
class About extends React.Component {
  ...
  async componentDidMount() {
    try {
      const response = await fetch("https://api.github.com/users/Hritul2");
      ...
      <div className="about">
          ...
          <div className="about-me-body">
            ...
            <div className="about-me-details">
              ...
              <div className="about-me-links">
                ...
                <Link
                  to={"https://github.com/Hritul2/FoodStall"}
                  target="_blank"
                  className="btn"
                >
                  <Code2Icon size={"1rem"} />
        ...
        <div className="about-project">
          ...
          <div className="about-project-text">
            <span>
              FoodStall is a food-ordering website that is built on top of the
              Swiggy API, a well-renowned food ordering platform. By seamlessly
              integrating technology with culinary expertise, FoodStall aims to
              provide users with a convenient and enjoyable platform for
              discovering, ordering, and savoring delicious meals from a variety
              of restaurants and eateries.
            </span>
            <span>
              The website boasts a sleek and user-friendly interface that makes
              browsing through menus and placing orders a breeze. Users can
              easily search for their favorite restaurant, explore new dining
              options, and customize their orders to suit their preferences.
              Whether craving traditional comfort food or exotic international
              flavors, FoodStall has something to satisfy every palate.
            </span>
          </div>
        </div>
      </div>
